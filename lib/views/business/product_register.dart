...
class _ProductRegisterState extends State<ProductRegister> {
  ...
  addProduct() {
    ...
    if(!emertimiEmpty && !qmimiEmpty && !amountEmpty && !pershkrimiEmpty){
      ...
      productController.addProduct(context, emertimi.text, qmimi.text, amount.text, pershkrimi.text, isOpen, isbrokable, isChange, file: photo)
          .then((value) {
        if(value == "success"){
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    Container(
                      padding: const EdgeInsets.only(left: 28, right: 20, top: 10),
                      child: Row(
