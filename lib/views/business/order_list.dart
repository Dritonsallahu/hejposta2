                    ...
                    child: NestedScrollView(
                        ...
                        body: SingleChildScrollView(
                          child: Column(
                            children: [
                              SizedBox(
                                height: getPhoneHeight(context) - 140,
                                child: RefreshIndicator(
                                  ...
                                  child: orderProvider.isFetchingPendingOrders()
                                      ...
                                      : orderProvider
                                          ...
                                          ? Center(
                                              child: Text(
                                              "Nuk keni asnje porosi ${orderStatus == "pending" ? "ne pritje" : ""}\n Ju lutem zgjedhni statusin per te pare listen e plote te porosive me statusin perkates.",
                                                          ...
                                                          SwipeActionCell(
                                                            ...
                                                            trailingActions: [
                                                              SwipeAction(
                                                                  ...
                                                                  content: Container(
                                                                      height: 120,
                                                                      decoration: BoxDecoration(borderRadius: const BorderRadius.only(topRight: Radius.circular(20), bottomRight: Radius.circular(20)), color: AppColors.bottomColorTwo),
                                                                      child: Center(
                                                                          child: Text(
                                                                        "Edito",
                                                                        style: AppStyles.getHeaderNameText(
                                                                            ...
                                                                            Column(
                                                                              children: [
                                                                                Text(
                                                                                  ...
                                                                                  style: AppStyles.getHeaderNameText(color: Colors.blueGrey[800], size: 20),
                                                                                ),
                                                                              ],
                                                                            ),
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                    ...
                                                                                    child: TextButton(
                                                                                        ...
                                                                                        child: Text(
                                                                                          "Jo",
                                                                                          style: AppStyles.getHeaderNameText(color: Colors.white, size: 17),
                                                                                        ))),
                                                                                Container(
                                                                                    height: 40,
                                                                                    width: getPhoneWidth(context) / 2 - 80,
                                                                  ...
                                                                  content: order
                                                                      ...
                                                                      : Container(
                                                                          ...
                                                                          child: Center(
                                                                            ...
                                                                            "Fshij",
                                                                            style:
                                                                                AppStyles.getHeaderNameText(color: Colors.white, size: 15.0),
                                                                          ))),
                                                                  color: Colors.transparent),
                                                            ],
                                                            child: Row(
                                                                    ...
                                                                    GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              "Klienti: ${order.receiver!.fullName} ",
                                                                              maxLines: 1,
